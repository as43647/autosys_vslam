...
if __name__ == '__main__':
    ...
    # python evaluate_rpe.py D:\dataset\tum\rgbd_dataset_freiburg1_room\groundtruth.txt D:\dataset\tum\rgbd_dataset_freiburg1_room\camera_trajectories_room.txt

    # python evaluate_rpe.py D:\dataset\tum\rgbd_dataset_freiburg3_walking_xyz\groundtruth.txt D:\dataset\tum\rgbd_dataset_freiburg3_walking_xyz\camera_trajectories_walking_xyz.txt

    # python evaluate_rpe.py D:\dataset\tum\rgbd_dataset_freiburg1_room\groundtruth.txt D:\dataset\tum\rgbd_dataset_freiburg1_room\camera_trajectories_room_noyolo.txt

    # python evaluate_rpe.py D:\dataset\tum\rgbd_dataset_freiburg3_walking_xyz\groundtruth.txt D:\dataset\tum\rgbd_dataset_freiburg3_walking_xyz\camera_trajectories_walking_xyz_noyolo.txt
