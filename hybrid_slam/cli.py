...
def build_parser():
    ...
    # 輸入模式: TUM數據集還是相機
    parser.add_argument("--input_mode", type=str, choices=["tum", "camera"], default="camera")

    parser.add_argument("--dataset_path", type=str, default="C:\\Users\\as436\\OneDrive\\文件\\xfeat\\rgbd_dataset_freiburg3_walking_xyz")
    ...
    parser.add_argument("--model_path", type=str, default="C:\\Users\\as436\\OneDrive\\文件\\xfeat\\autosys_mdepth_optm.onnx") # 深度估計模型路徑
    parser.add_argument("--seg_path", type=str, default="C:\\Users\\as436\\OneDrive\\文件\\xfeat\\yolo11n-seg.pt") # 分割模型路徑
    ...
    parser.add_argument("--max_depth_m", type=float, default=8.0)
